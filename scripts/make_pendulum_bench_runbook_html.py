...
<tr><td>1</td><td>输出轴<b>水平</b>, 摆臂在竖直平面内 ±101° 自由摆动(无碰撞)</td><td>重力矩 B(θ) 需要 sin θ 形式</td></tr>
...
<li>断电手动摆过 ±101°（默认轨迹集真实峰值 sin_sin ±100.8°，非旧说的 ±90°），确认不碰台架、桌面、线缆和挡板。</li></ol>
...
单次最大摆幅 <b>±100.8°</b>（= 1.7592 rad，超过水平约 10.8°；旧说"~±90°"是误算——主摆到 ±90° 时调制项恰为 0，但全局峰值出现在别处 t≈2.156 s）。摆杆扫过平面 <b>清空此方向</b>。</td></tr>
...
所有工况都<b>从下垂零位开始、结束后回到零位</b>再等 0.5 s。摆幅速查：sin_time_square ≈±57°；sin_sin <b>±100.8°</b>（叠高频，超水平）；lift_and_drop → -90°（断扭后自由摆到对侧 ≈+54°）；up_and_down → 0°…+90°…+72°。</p>
