<!-- 官方文档存档：飞特 doc.feetech.cn 文档站《舵机SCS通信协议》
     来源: http://doc.feetech.cn/#/tiaozhunlujingft?srcType=FT-SCS-Protocol-41ad23fe8a244712ba160b93
     文档: SCS通信协议 / code FT-SCS-Protocol（与磁编码HLS舵机内存表配套）
     用途: HL-2909-C001 运行时协议实现的官方依据（原始 Markdown，未改动） -->
