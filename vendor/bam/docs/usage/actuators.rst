...
.. list-table::
    ...
    * - **HL-2909-C001**
      ...
      - ``hls2909``
      - Feetech HL-2909-C001 servo-actuator (12 V): position servo mode with a
        firmware velocity+acceleration rate-limited target and P(1/8)+D(1/4) gains
        (`Parameters <https://github.com/Rhoban/bam/tree/main/bam/params/hls2909>`__,
        `model <https://github.com/Rhoban/bam/blob/main/bam/feetech/actuator.py>`__)
      - .. raw:: html

           <a class="sd-btn sd-btn-outline-primary motor-btn" href="mujoco_cpu.html?motor=hls2909">Use in MuJoCo</a>
           <a class="sd-btn sd-btn-outline-primary motor-btn" href="mjlab_gpu.html?motor=hls2909">Use in mjlab</a>

    * - **HD-1910-C001**
      - *(photo pending)*

      - ``hd1910``
      - Feetech HD-1910-C001 servo-actuator (6 V): position servo mode controller
        (firmware mode 4, Sim2Real); register map and gain scaling pending
        verification against the official memory table
        (`Parameters <https://github.com/Rhoban/bam/tree/main/bam/params/hd1910>`__,
        `model <https://github.com/Rhoban/bam/blob/main/bam/feetech/actuator.py>`__,
        `identification notes <https://github.com/Rhoban/bam/blob/main/docs/identification/hd1910_servo_notes.md>`__)
      - .. raw:: html

           <a class="sd-btn sd-btn-outline-primary motor-btn" href="mujoco_cpu.html?motor=hd1910">Use in MuJoCo</a>
           <a class="sd-btn sd-btn-outline-primary motor-btn" href="mjlab_gpu.html?motor=hd1910">Use in mjlab</a>
